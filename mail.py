...
# В ЯНДЕКСЕ: настройки->все настройки->почтовые программы->ставим везде галочки
    msg = MIMEMultipart()
    to_email = 'kubbi11@yandex.ru' #указываем ту почту, с которым мы залогинились
    message = 'кто читает у того будет 75 миллионов долларов'
    from_email = 'kubbi11@yandex.ru' #логинимся на почту (желательно яндекс)
    password = 'A666777228' #пароль
